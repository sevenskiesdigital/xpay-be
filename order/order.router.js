...
const { createOrder, getOrderBySellerId, getOrderByBuyerId, getOrderByCode, shipOrder, uploadImage, finishOrder, statusOrder, getOrderHistoryByOrderId } = require("./order.controller");
const { checkToken } = require("../auth/token_validation");

router.post("/create", checkToken, createOrder);
router.get("/seller", checkToken, getOrderBySellerId);
router.get("/history", checkToken, getOrderHistoryByOrderId);
